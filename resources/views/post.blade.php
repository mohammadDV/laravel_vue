...
<head>
    ...
    <title>Job position in Aloware Company</title>

    <link href="/css/app.css" rel="stylesheet">
</head>
<body class="vt-theme-cyan-light">
                    ...
                    <div class="card-body">
                        <div class="post">
                            <div class="post--header">
                                <div class="post--cover ratio ratio-16x9" style="background-image: url('/images/post.png');">
                                    <div class="post--header--overly"></div>
                                    <div class="post--head-info">
                                        <div class="extend-info">
                                            <span>
                                                <span class="post-date"></span>
                                                <span class="post-view">views: {{rand(1000,9999)}}</span>
                                            </span>
                                        </div>
                                        <div class="main-info">
                                            <span class="fs-6 post--subtitle">Job position in Aloware Company</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="post--body">
                                <div class="post--lead">
                                    <span>Job position in Aloware Company</span>
                                </div>
                        ...
                        <div class="post-tag-list">
                            <div class="tag-list-item">
                                <span class="text-primary size-font">#</span>
                                <span>Job</span>
                    ...
                    <div class="card-header">
                        <ul class="nav" id="hotties" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" id="latest-tab" data-bs-toggle="tab">
                                    Others
                                </a>
                            </li>
                        </ul>
